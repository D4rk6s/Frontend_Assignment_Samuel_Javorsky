    ...
    <div className={`min-h-screen transition-colors duration-300 ${theme === 'dark' ? 'bg-gray-900' : 'bg-white'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
        <div className="mb-8">
          ...
          <h1 className={`text-2xl sm:text-3xl lg:text-4xl font-bold mb-8 sm:mb-12 transition-colors duration-300 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>
                 {isMounted ? t('pages.contact.title') : 'Kontakt'}
          </h1>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16">
          <div className="text-center">
            ...
            <h3 className={`text-lg font-semibold mb-2 transition-colors duration-300 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>{t('pages.contact.email.title')}</h3>
            <p className={`mb-2 transition-colors duration-300 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>{t('pages.contact.email.description')}</p>
            <a 
          ...
          <div className="text-center">
            ...
            <h3 className={`text-lg font-semibold mb-2 transition-colors duration-300 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>{t('pages.contact.office.title')}</h3>
            <p className={`mb-2 transition-colors duration-300 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>{t('pages.contact.office.description')}</p>
            <a 
              ...
              className="text-[#4F46E5] hover:text-[#3B3B9A] transition-colors"
            >
              {t('pages.contact.office.address')}
            </a>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className={`text-lg font-semibold mb-2 transition-colors duration-300 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>{t('pages.contact.phone.title')}</h3>
            <p className={`mb-2 transition-colors duration-300 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>{t('pages.contact.phone.description')}</p>
            <a 
